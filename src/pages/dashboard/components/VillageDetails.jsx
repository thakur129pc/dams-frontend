  ...
  return (
    <div className="border border-gray-300 p-4 rounded-lg shadow-xl bg-white flex justify-between flex-col">
      ...
      <div className="flex justify-between flex-wrap gap-2 items-center w-full text-xs">
        {/* View details */}
        <button
          className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 shadow-lg"
          onClick={() =>
            navigate(
        ...
        {userRole === "0" && (
          <button
            className="bg-green-500 hover:bg-green-600 text-white px-2 py-1 flex items-center gap-1 shadow-lg"
